// Chapter20_06.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
	...
	*/
    ...
    uniform_int_distribution<> uniform_distribution(1, 10);

    for (long long i = 0; i < n_data; ++i)
    {
        v0.push_back(uniform_distribution(engine));
        v1.push_back(uniform_distribution(engine));
    }
